...
**Google Chrome** is one of the **best** internet browsers because it is easy to use, and it syncs your preferences and bookmarks across multiple devices. However, Chrome is **slow compared** to **other** browsers.
...
**Mozilla Firefox** is a versatile, feature-rich browser that’s good for both **casual** browsing and **intensive** research. It also does a good job of blocking fishing schemes and malware downloads.
...
* For Opera you need to install **Snapcraft** too if you **don’t** had installed (**already** in the **commands** from **main page**);
...
If you **already** had **installed** just use the last command (sudo snap install opera).
